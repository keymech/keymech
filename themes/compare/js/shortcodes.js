(function($) {
	...
	if( typeof tinymce != 'undefined' ){
	    tinymce.create('tinymce.plugins.compare', {
	        init : function(ed, url) {
	        	instance = ed;        	
				ed.addButton('comparegrid', {
					type: 'listbox',
					text: 'Compare Grid',
					icon: false,
					onselect: function(e) {
	    ...
	    // Register plugin
	    tinymce.PluginManager.add( 'compare', tinymce.plugins.compare );
	}
})(jQuery);
